package toy.first.coffeediary.config.jwt;
...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter{
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		String header = request.getHeader(toy.first.coffeediary.config.jwt.JwtProperties.HEADER_STRING);
		if(header == null || !header.startsWith(toy.first.coffeediary.config.jwt.JwtProperties.TOKEN_PREFIX)) {
